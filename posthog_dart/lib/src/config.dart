...
class PostHogConfig {
  ...
  /// If set to true the SDK is disabled entirely (useful for local
  /// environments where you don't want to track anything).
  final bool disabled;
  ...
  /// Whether to send default person properties (platform context) with
  /// feature flag evaluation requests. Explicitly set person properties
  /// override the defaults.
  final bool setDefaultPersonProperties;
  ...
  const PostHogConfig({
    ...
    this.setDefaultPersonProperties = true,
